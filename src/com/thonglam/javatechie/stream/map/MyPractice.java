...
public class MyPractice {
    ...
    public static void main(String[] args) {
        Map<Employee1, Integer> employeeMap1 = new TreeMap<>((o1, o2)->(int) (o1.getSalary() - o2.getSalary()));
    ...
    Map<Employee1, Integer>  employeeMap = new HashMap<>();
     ...
     employeeMap.entrySet().stream().sorted(Map.Entry.comparingByKey(Comparator.comparing(Employee1::getSalary)))
             .map(x->x.getValue());
    }
}
